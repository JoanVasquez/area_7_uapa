...
public class GenerateReport {
	...
	public void generateReport() {
		try {
            ...
            String[] fieldNames = {"id", "name", "address", "age"};
            ...
            String[] columnHeaders = {"ID", "Nombre", "Direccion", "Edad"};
            ...
            List<User> data = new UserDao().getEntities();
            ...
            JasperExportManager.exportReportToPdfFile(jasperPrint, "User_Reporte.pdf");
